...
202#curl -o /data/ShellCrash/GeoSite.dat -L https://ghgo.xyz/https://github.com/DustinWin/ruleset_geodata/releases/download/clash/geosite.dat && curl -o /data/ShellCrash/GeoIP.dat -L https://ghgo.xyz/https://github.com/DustinWin/ruleset_geodata/releases/download/clash/geoip-lite.dat && curl -o /data/ShellCrash/Country.mmdb -L https://ghgo.xyz/https://github.com/DustinWin/ruleset_geodata/releases/download/clash/Country-lite.mmdb && /data/ShellCrash/start.sh restart >/dev/null 2>&1#更新geodata路由规则文件
