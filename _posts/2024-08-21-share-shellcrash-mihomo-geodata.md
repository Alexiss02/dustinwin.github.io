...
## 一、 生成配置文件 .yaml 文件直链
具体方法此处不再赘述，请看《[生成带有自定义策略组和规则的 mihomo 配置文件直链-geodata 方案](https://proxy-tutorials.dustinwin.top/posts/link-mihomo-geodata)》，贴一下我使用的配置：
...
202#curl -o /data/ShellCrash/GeoSite.dat -L https://ghgo.xyz/https://github.com/DustinWin/ruleset_geodata/releases/download/mihomo/geosite.dat && curl -o /data/ShellCrash/GeoIP.dat -L https://ghgo.xyz/https://github.com/DustinWin/ruleset_geodata/releases/download/mihomo/geoip-lite.dat && curl -o /data/ShellCrash/Country.mmdb -L https://ghgo.xyz/https://github.com/DustinWin/ruleset_geodata/releases/download/mihomo/Country-lite.mmdb && /data/ShellCrash/start.sh restart >/dev/null 2>&1#更新geodata路由规则文件
